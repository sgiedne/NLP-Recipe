...
aLinkForToolTransform = 'http://allrecipes.com/recipe/132815/balsamic-roasted-pork-loin/'
original_recipe = getAllData(aLinkForToolTransform)


directions = getDirections(aLinkForToolTransform)
...
# Output: Fraction                
#==============================================================================
def update_fraction(a_fraction, increase_value, isDenominator):
    a_fraction_in_fraction_format=Fraction(a_fraction)
    the_denominator=a_fraction_in_fraction_format.denominator
    the_numerator=a_fraction_in_fraction_format.numerator
    if isDenominator:
#        old_denominator=a_fraction_in_fraction_format.denominator
        the_denominator =the_denominator+increase_value
    else:
        the_numerator   =the_numerator+increase_value
    
    new_fraction= Fraction(the_numerator,the_denominator)
    return new_fraction

#==============================================================================
# PPS:   Increasing  the denominator by 1
# Input: Fraction in string
# Output: Fraction in string               
#==============================================================================
def decrease_quantity(a_fraction):
    return str(update_fraction(a_fraction,1,True))

#==============================================================================
# PPS:   Decreasing  the denominator by 1
# Input: Fraction in string
# Output: Fraction in string               
#==============================================================================
def increase_quantity(a_fraction):
    return str(update_fraction(a_fraction,1, False))
...
for index,vaule in enumerate(glb_ingredients_list):
    try:
        ...
        if "butter" in lower_ingredient:
            ...
            upd_quantity = decrease_quantity(prev_quantity)   
...
def Updata_Quantity_list(protein_list, ingre_list,quantity_list):
...
print glb_tools_list
print glb_methods_list
print directions_list


glb_tools_list   =replace_elements("oven", "pan", glb_tools_list)
glb_methods_list =replace_elements("bake", "fry", glb_methods_list)
directions_list  =update_steps_in_tool_transform(['bake','Bake'],'fry',directions_list)

print "Original quantity list"
print glb_ingredients_quantity_list
glb_ingredients_quantity_list=Updata_Quantity_list(protein_list,glb_ingredients_list,glb_ingredients_quantity_list)
